...
<div>
    ...
    <form action="{{ route('purchases.addItem') }}" method="post" class="flex flex-col sm:block border rounded-md shadow-md p-5 bg-gray-50 mb-8">
        @csrf
        <div class="md:flex">
            <div class="md:w-1/4 md:me-4 md:min-w-min">
        ...
        <div class="md:flex">
            ...
            <div class="md:w-max md:pt-8">
                <button class="w-max bg-blue-500 rounded-md py-2 px-3 text-neutral-100 shadow-md shadow-neutral-400">Adicionar Item</button>    
            </div>
        </div>  
    </form>
        ...
        <table class="w-full border border-collapse bg-gray-100 text-neutral-700">
            ...
            <tbody>
                ...
                <tr class="border text-neutral-500">
                    <th class="py-3 text-center bg-gray-200" colspan="3" scope="row" >Total</th>
    ...
    <a href="{{ route('purchases.create') }}" class="w-max bg-green-600 rounded-md py-2 px-3 text-neutral-100 shadow-md shadow-neutral-400">Registrar Compra</a>
</div>
@endsection
