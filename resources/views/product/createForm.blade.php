...
<div>
    ...
    <form action="{{ route('products.store') }}" method="POST" class="flex flex-col border rounded-md shadow-md p-5 bg-gray-50 mb-8">
        ...
        <div>
            ...
            <input type="text" id="code" name="code" value="{{ old('code') }}" class="w-full p-2 rounded-md border-0 outline-0 shadow-md ring-1 ring-inset ring-gray-300 focus:ring focus:ring-inset focus:ring-neutral-800  text-gray-900 mb-4">
            @error('code')
        ...
        <div>
            ...
            <input type="text" id="description" name="description" value="{{ old('description') }}" class="w-full p-2 rounded-md border-0 outline-0 shadow-md ring-1 ring-inset ring-gray-300 focus:ring focus:ring-inset focus:ring-neutral-800  text-gray-900 mb-4">
            @error('description')
        ...
        <div>
            ...
            <input type="text" id="purchase_price" name="purchase_price" value="{{ old('purchase_price') }}" class="w-full p-2 rounded-md border-0 outline-0 shadow-md ring-1 ring-inset ring-gray-300 focus:ring focus:ring-inset focus:ring-neutral-800  text-gray-900 mb-4">
        ...
        <div>
            ...
            <input type="text" id="sale_price" name="sale_price" value="{{ old('sale_price') }}" class="w-full p-2 rounded-md border-0 outline-0 shadow-md ring-1 ring-inset ring-gray-300 focus:ring focus:ring-inset focus:ring-neutral-800  text-gray-900 mb-4">
            @error('sale_price')
        ...
        <div>
            ...
            <input type="text" id="storage" name="storage" value="{{ old('storage') }}" class="w-full p-2 rounded-md border-0 outline-0 shadow-md ring-1 ring-inset ring-gray-300 focus:ring focus:ring-inset focus:ring-neutral-800  text-gray-900 mb-4">
            @error('storage')
